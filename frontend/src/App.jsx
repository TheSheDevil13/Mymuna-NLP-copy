...
function App() {
  ...
  const convertWebmToWav = async (webmBlob) => {
    ...
    // The backend might need to handle webm or you can convert client-side
    // For now, let's try sending webm and see if it works
    return webmBlob
  }
  ...
  const sendAudioToBackend = async (audioBlob) => {
    ...
    try {
      ...
      // Try sending as webm first, or convert to wav
      // For now, we'll create a File object with wav extension
      ...
      // Get the JSON response with text and audio
      ...
      // Add messages to chat with actual text
      setMessages(prev => [
        ...prev,
